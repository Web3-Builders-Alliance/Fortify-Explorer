              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-sm md:text-base text-gray-600 font-medium  leading-7">
                ...
                >
                  <div>
                    ...
                    <div className="text-sm md:text-base text-gray-600 font-medium leading-7">
                      Presenting our user explorer called Fortress. Fortress is
                      a comprehensive block explorer designed specifically for
                      Solana users. It includes advanced features such as Wallet
                      Scan and Wallet Health, coupled with a scoring system to
                      assess the health and strength of your wallet.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
